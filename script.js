date = new Date(), months = ["January", "February", "March", "April", "May", "June", "July", "August", "Septmber", "October", "November", "December"], year = date.getFullYear(), colors = ["black","maroon","red","orange","yellow","silver","#afa","lime","#0c8","cyan","#0af"], textcolors = ["red","#f88","black","black","black","black","black","black","black","green","lime"], days = document.getElementById("days"), i = 0, music = new Audio("Music.mp3");
